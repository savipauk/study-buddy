...
-- Glavna tablica za sve korisnike
CREATE TABLE Users (
...
-- Tablica za studente, vezana uz Users
...
-- Tablica za profesore, vezana uz Users
...
-- Tablica za administratore, vezana uz Users
CREATE TABLE Admins (
...
-- Tablica za grupe za učenje, vezana uz Students
...
-- Tablica za članove grupe, gdje su svi članovi studenti
...
-- Tablica za lekcije, gdje su svi lekcije kreirane od strane profesora
...
-- Tablica za sudionike lekcija, gdje su svi sudionici studenti
